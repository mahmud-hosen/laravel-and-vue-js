        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-6 mt-2">
            <div class="card card-primary">
              ...
              <form role="form" @submit.prevent="categorySave"  enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <textarea
                            id="cat_description" v-model="cat_description" name="cat_description"
                            class="form-control"
                            rows="4"
                        ></textarea>
                        </div>
                        ...
                        <input
                            type="file" 
                            id="cat_img" name="cat_img" @change="getImg"
                            class="form-control"
                        />
                        </div>
                    </div>
